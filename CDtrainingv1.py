...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # for original model of keratitis
    # mean = [0.5765036, 0.34929818, 0.2401832], std = [0.2179051, 0.19200659, 0.17808074]

    # for quality_images model of keratitis
    # mean = [0.56806844, 0.34380817, 0.23604481], std = [0.22718193, 0.197301, 0.1810014]
